...
func sentinelRuleInit(configClient config_client.IConfigClient) {
	...
	flowSource, err := sentinelNacosDataSource.NewNacosDataSource(configClient, "DEFAULT_GROUP", "sentinel_checkout_flow_rules.json", flowRulesHandler)
	if err != nil {
	...
	circuitBreakerSource, err := sentinelNacosDataSource.NewNacosDataSource(configClient, "DEFAULT_GROUP", "sentinel_checkout_circuit_breaker_rules.json", circuitBreakerRulesHandler)
	if err != nil {
