...
func (x *CategorySelectReq) GetCategoryId() int32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
func (x *CategoryDeleteReq) GetCategoryId() int32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
func (x *CategoryUpdateReq) GetCategoryId() int32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
var file_category_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x22, 0x83,
	...
	0x05, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x22, 0x54, 0x0a,
