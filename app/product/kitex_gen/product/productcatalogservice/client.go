...
func (p *kProductCatalogServiceClient) UnlockProductQuantity(ctx context.Context, Req *product.ProductUnLockQuantityRequest, callOptions ...callopt.Option) (r *product.ProductUnLockQuantityResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UnlockProductQuantity(ctx, Req)
}
